...
const SEED_CHAPTERS = [
  ...
  makeChapter('2026-08-04', 'Maths', 'Differentiability'),
  ...
  makeChapter('2026-08-11', 'Chemistry', 'Nitrogen-containing Compounds'),
  ...
  makeChapter('2026-09-19', 'Physics', 'Thermal Expansion of Matter'),
  ...
  makeChapter('2026-10-19', 'Physics', 'Conductors and Dielectrics'),
  ...
  makeChapter('2026-11-05', 'Physics', 'Error and Measurements Optical Instruments'),
  makeChapter('2026-11-07', 'Chemistry', 'Electrochemistry'),
